...
import { createValidator, DEFAULT_SCHEMA, TEMPLATE } from '@heai-tools/architect'
...
const schemaPath = resolve(argValue('--schema') ?? process.env.SCHEMA_FILE ?? DEFAULT_SCHEMA)
